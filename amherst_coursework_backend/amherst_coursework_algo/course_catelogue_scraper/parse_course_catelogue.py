...
def get_all_department_courses():
    ...
    try:
        ...
        with open(
            "course_catelogue_scraper/parsing_results/department_catelogue_links.json",
            "r",
        ) as f:
        ...
        output_path = (
            "course_catelogue_scraper/parsing_results/all_department_courses.json"
        )
...
def parse_all_courses(testing_mode: bool = False):
    ...
    output_path = (
        "course_catelogue_scraper/parsing_results/parsed_courses_detailed.json"
    )
    failed_urls = []
    ...
    try:
        ...
        with open(
            "course_catelogue_scraper/parsing_results/all_department_courses.json", "r"
        ) as f:
            departments = json.load(f)
...
def parse_all_courses_second_deg():
    ...
    output_path = (
        "course_catelogue_scraper/parsing_results/parsed_courses_second_deg.json"
    )
